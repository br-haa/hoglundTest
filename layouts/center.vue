    ...
    <hero2 :theme="themes.dark">
      ...
      <template v-slot:text>
        <div>
          ...
          <h2 id="subHead" :style="customStyles.darkText">File Now - Pay Attorney Fees Later</h2>
          <h4 id="blerb" :style="customStyles.darkAccentText">Free Confidential Phone Consultation<br>With An
...
export default {
  components: { DynamicButton, DisclaimerAndCopyright, Testimonials, ContactBlock, ReviewBlock, Scroller, FloatingBlock, Hero2, Header0 },
  data(){
    return{
      themes:{
        light:{
